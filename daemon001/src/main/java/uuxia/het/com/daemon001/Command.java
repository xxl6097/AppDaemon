package uuxia.het.com.daemon001;
 ...
 *
 * File: Command.java
 * Create: 2016/1/12 10:07
 */
public class Command {
    private static final String TAG = "uulog.jni";
    ...
    public static void copyAssets(Context context, String assetsFilename, File file, String mode)
        ...
        Log.d(TAG, "==========copyAssets  "+file.getAbsolutePath());
    }
    ...
    public static boolean install(Context context, String destDir, String filename) {
        ...
        try {
            ...
            if (f.exists()) {
                Log.d(TAG, "binary has existed"+f.getAbsolutePath());
                return false;
            }
            Log.d(TAG, "binary "+f.getAbsolutePath());
